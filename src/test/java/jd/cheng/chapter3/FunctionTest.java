...
public class FunctionTest {
	...
	public void testKeyBy() throws Exception {
		...
		DataStreamSource<PayWithBalanceTrx> src = env.fromElements(new PayWithBalanceTrx(1, "RECOUP"), new PayWithBalanceTrx(2, "RECOUP"),
				new PayWithBalanceTrx(3, "DISPUTE_HOLD"), new PayWithBalanceTrx(4, "SHIPPING_LABEL_CHARGE"),
		...
		.apply(new WindowFunction<PayWithBalanceTrx, PayWithBalanceTrx, Tuple, GlobalWindow>() { // collect all trx whose type is RECOUP
			public void apply(Tuple key, GlobalWindow window, Iterable<PayWithBalanceTrx> input, Collector<PayWithBalanceTrx> out) throws Exception {
